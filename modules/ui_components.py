...
from modules.config_loader import save_die_preferences
...
def render_manual_machine_assignment(cfg, df, maquinas_activas):
    ...
    mode = st.radio("Modo de Asignación:", ["Por Máquina (Lista)", "Por Tarea (Búsqueda inteligente)"], horizontal=True)
